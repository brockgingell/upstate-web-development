...
export function SiteHeader() {
  ...
  return (
    <header> {isMenuOpen ? 
      <>
        <div className="fixed top-0 z-50 flex w-screen flex-col border-b-2 bg-background">
      ...
      :
      <>
        <div className="fixed top-0 z-50 flex h-[70px] w-screen flex-row items-center justify-between border-b-2 bg-background">
          <NavLogo />
